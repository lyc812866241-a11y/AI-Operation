...
| 文件 | 内容 |
|---|---|
| ★ `.ai-operation/wisdom.md` | **二阶 跨项目通用智慧**（求导思维等普适方法论）|
...
| 经验沉淀协议（求导提炼） | `.ai-operation/skills/lesson-distill/SKILL.md` |
| 状态快照协议（The Engine） | `.ai-operation/skills/state-checkpoint/SKILL.md` |
