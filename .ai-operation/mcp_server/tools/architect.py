...
def _generate_toc(content: str, filename: str) -> str:
    """Generate a table-of-contents summary of a markdown file.

    Extracts ## section headers and first line of each section body.
    Used when budget is tight — shows structure without full content.
    """
    import re
